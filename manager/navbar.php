        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="http://gravatar.com/avatar/<?php echo md5(getInformation('email')) ?>?s=25&d=<?php echo urlencode($config['users']['default_avatar'])?>"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            <img src="http://gravatar.com/avatar/<?php echo md5(getInformation('email')) ?>?s=90&d=<?php echo urlencode($config['users']['default_avatar'])?>"
